    ...
    "paths": {
        ...
        "/categorias/create": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Erro ao decodificar a categoria",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/categorias/update": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Dados da Categoria (deve conter ID)",
                        "name": "cat",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/itens/create": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Erro ao decodificar o item",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/itens/update": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Dados do Item (deve conter ID)",
                        "name": "item",
                        "in": "body",
                        "required": true,
                        "schema": {
